                        ...
                        <div class="user-profile col-lg-3 col-md-4 col-sm-4 text-lg-center">
                            <div class="user-profile-picture position-relative">
                                <div class="user-profile-picture-inner rounded-circle">
                                    <img class="rounded-circle img-fluid" src="https://source.boringavatars.com/beam/120/{{Auth::user()->foto}}?square&colors=FAD089,FF9C5B,F5634A,ED303C,3B8183" alt="" style="height: 150px; width:150px">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8 mb-2">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="form-input" name="foto" value="{{ Auth::user()->foto }}">
                                        </div>
                            ...
                            <div class="user-settings__wrapper">
                                ...
                                <form method="POST" action="" accept-charset="UTF-8" role="form" autocomplete="off" id="settings-email-form"><input name="_token" type="hidden" value="">
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="form-group col-md-8 mb-2">
                                                <label for="email" class="font-weight-bold">Email Baru<span class="text-danger">*</span></label>
                                                <div class="input-group mb-3">
                                                    <input id="email" type="email" class="form-control" placeholder="contoh@gmail.com"
                                                    :value="old('email', $request->email)" name="email" required>
                                                </div>
                            ...
                            <div class="user-settings__wrapper">
                                ...
                                <form method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="form-group col-md-8 mb-2">
                                                <label for="password" :value="__('Password Baru')" class="font-weight-bold">Password Baru<span class="text-danger">*</span></label>
                                                <div class="input-group mb-3">
                                                    <input id="password" type="password" class="form-control" placeholder="Masukkan password baru" name="password" required minlength="8">
                                                </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8 mb-2">
                                                <label for="password_confirmation" :value="__('Konfirmasi Password Baru')" class="font-weight-bold">Konfirmasi Password Baru<span class="text-danger">*</span></label>
                                                <div class="input-group mb-3">
                                                    <input id="password_confirmation" type="password" class="form-control" placeholder="Konfirmasi password" name="password_confirmation" required minlength="8">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pt-2">
                                        <button type="submit" class="btn btn-primary" style="border-radius:25px" type="submit">{{ __('Simpan Password') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="user-settings__wrapper">
                                ...
                                <form method="POST" action="{{route('dataalumni.store')}}" enctype="multipart/form-data"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-8 mb-2">
                                            <label class="font-weight-bold" for="tempat_lahir">Tempat Lahir<span class="text-danger">*</span></label>
                                            <div class="input-group mb-3">
